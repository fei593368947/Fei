					...
					$(data).each(
						function(){
							if ($("#udep2").val()==this.id) {
								//设置下拉框属性
								$("#dep2").append("<option value='"+this.id+"' selected='selectde'>"+this.name+"</option>");
							} else {
								//设置下拉框属性
			...
			<tbody>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						密码:</td>
						<td width="80%" class="pn-fcontent">
						<input id="password" type="password" class="required" value="${USER.password }" name="password" maxlength="100"/>
						<span id="passwordmsg" />
					</td>
				</tr>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						确认密码:</td>
						<td width="80%" class="pn-fcontent">
						<input id="conpwd"  type="password" class="required" value="${USER.password }" name="conpwd" maxlength="100"/>
					</td>
				</tr>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						真实姓名:</td>
						<td width="80%" class="pn-fcontent">
						<input id="realname" type="text" class="required" value="${USER.realname }" name="realname" maxlength="100"/>
						<span id="realnamemsg" />
					</td>
				</tr>
